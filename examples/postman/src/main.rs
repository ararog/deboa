...
async fn main() -> Result<()> {
    ...
    let posts: Vec<Post> = post_service
        .get_posts()
        .await
        .unwrap();
    println!("Posts: {posts:#?}\n");
    ...
    let result = post_service
        .create_post(Post { id: 1, title: "title".to_string(), body: "body".to_string() })
        .await;
    ...
    let result = post_service
        .update_post(1, Post { id: 1, title: "title".to_string(), body: "body".to_string() })
        .await;
