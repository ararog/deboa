...
//! | `rust-tls`    | Yes      | Support for rust-tls (enabled by default).        |
...
//! ```toml
//! [dependencies]
//! deboa-tokio = { version = "0.1.0", features = ["http2", "rust-tls", "default-rustls-provider", "default-rustls-verifier"] }
//! ```
//!
...
//! ```toml
//! [dependencies]
//! deboa-tokio = { version = "0.1.0", default-features = false }
//! ```
//!
